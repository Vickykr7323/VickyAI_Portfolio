...
const BADGES = [
  {
    ...
    subtitle: "National Level Certification",
    category: "academic",
    icon: Code,
    description: "Awarded Python Programming Certification, validating profound expertise in scripting, object models, and syntax optimization.",
    color: "from-emerald-400 via-teal-500 to-green-500",
    glowColor: "rgba(16, 185, 129, 0.4)",
    accolade: "Verified Certified • 2024",
  },
  {
    id: "cert-iitb-jv",
    title: "Java Systems Specialist",
    subtitle: "National Level Certification",
    category: "academic",
    icon: Binary,
    description: "Awarded subject-matter certification in Java Programming, demonstrating mastery of multi-threaded systems and JVM optimization.",
    color: "from-orange-400 via-red-500 to-amber-500",
    glowColor: "rgba(249, 115, 22, 0.4)",
    accolade: "Verified Certified • 2024",
  },
  {
    id: "cert-intellipaat-mern",
    title: "MERN Stack Specialist",
    subtitle: "Intellipaat Certification",
    category: "academic",
    icon: Award,
    description: "Certified MERN Stack Developer skilled in MongoDB, Express.js, React, Node.js, and RESTful API architecture.",
    color: "from-blue-400 via-indigo-500 to-violet-500",
    glowColor: "rgba(59, 130, 246, 0.4)",
    accolade: "Intellipaat Certified • 2024",
  },
  {
    id: "cert-intellipaat-mean",
    title: "MEAN Stack Specialist",
    subtitle: "Intellipaat Certification",
    category: "academic",
    icon: Award,
    description: "Certified MEAN Stack Developer proficient in Angular, Node.js, Express, and database management systems.",
  ...
  },
  {
    ...
    subtitle: "Computer Science Educator",
    category: "academic",
    icon: GraduationCap,
    description: "Experienced educator guiding undergraduate students in core programming, Outcome-Based Education (OBE), and computer science fundamentals.",
    color: "from-sky-400 via-cyan-500 to-teal-500",
    glowColor: "rgba(6, 182, 212, 0.4)",
    accolade: "Computer Science Educator • 2025",
  },
  {
    id: "proj-mentor",
    title: "Academic Project Advisor",
    subtitle: "10+ Projects Supervised",
    category: "academic",
    icon: FolderGit2,
    description: "Supervised and mentored student groups in developing full-stack web applications, AI portals, and database software systems.",
    color: "from-amber-400 via-yellow-500 to-orange-500",
    glowColor: "rgba(245, 158, 11, 0.4)",
    accolade: "Project Mentor • 2025",
  },
];
...
export default function Achievements({ currentTheme }: AchievementsProps) {
  ...
  const stats = [
    ...
    { 
      ...
      icon: Users,
      description: "Organized and delivered 11 campus-wide technical sessions, training students in programming languages, Data Structures & Algorithms, web development, and project building.",
      sparklineData: [
        { month: "Aug", value: 2 },
        { month: "Sep", value: 3 },
        { month: "Oct", value: 4 },
    ...
    { 
      ...
      icon: Award,
      description: "Holds technical certifications validating subject mastery in programming, full-stack web development, and computer science pedagogy.",
      sparklineData: [
        { month: "Aug", value: 2 },
        { month: "Sep", value: 2 },
        { month: "Oct", value: 3 },
